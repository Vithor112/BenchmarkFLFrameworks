...
echo "Starting FEDBIOMED with the following parameters:"
...
python stop.py
python launch.py --num_of_clients $CLIENTS --num_of_rounds $ROUNDS --epochs $EPOCHS --batch_size $BATCH_SIZE --seed $SEED